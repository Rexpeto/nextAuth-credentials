        ...
        {user?.name ? (
          <div className="flex items-center md:order-2">
            ...
            <div
              className={`z-50 ${
                showMenu
                  ? "block absolute translate-y-24 translate-x-[-7rem]"
                  : "hidden"
              } my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-600`}
              id="user-dropdown"
            >
